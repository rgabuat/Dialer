<div class="min-h-screen bg-zinc-950 text-zinc-100 p-6">
    ...
    <div class="mb-8 flex items-center justify-between">
        <div>
            ...
            <p class="text-sm text-zinc-400">Update campaign details.</p>
        </div>
        @can('campaign.delete')
        ...
        <div class="mb-6 rounded-md bg-red-500/10 border border-red-500/20 px-4 py-4 flex items-center justify-between gap-4">
            ...
            <div class="flex gap-3 shrink-0">
                ...
                <button wire:click="$set('confirmingDelete', false)"
                    class="px-3 py-1.5 rounded-md bg-zinc-700 hover:bg-zinc-600 text-zinc-300 text-sm font-medium transition">
                    Cancel
                </button>
            </div>
        </div>
