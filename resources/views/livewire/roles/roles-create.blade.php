<div class="space-y-4 p-6">
    ...
    {{-- Page title --}}
    <div>
        <h1 class="font-bold text-zinc-100 text-xl">Create Role</h1>
    ...
    <div class="bg-zinc-900 border border-zinc-800 rounded-xl overflow-hidden">
        <div class="flex justify-between items-center px-5 py-4 border-zinc-800 border-b">
            <div>
                <h2 class="font-semibold text-zinc-100 text-sm">Assign Permissions</h2>
    ...
    <div class="flex items-center gap-3 py-1">
        ...
        <a href="{{ route('roles.index') }}" wire:navigate class="text-zinc-400 hover:text-zinc-200 text-sm transition">
            Cancel
        </a>
    </div>
